 ...
 */
final class Version20200219184724 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migratputeion can only be executed safely on \'mysql\'.');
